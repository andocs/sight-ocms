...
export default function Navbar() {
  ...
  const isDashboardRoute = ['/admin', '/patient', '/doctor', '/technician'].some((route) =>
  location.pathname.startsWith(route)
  );
   
  return (
    <div id='navbar' className='z-50 sticky w-full bg-white'>
    <Disclosure as="nav">
      {({ open }) => (
        <>
              ...
              <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                <a href="/home" className="z-50 flex-none lg:max-w-xs px-6">
                  <img
                    ...
                    alt="Your Company"
                  />
                  <p className="hidden h-14 w-auto lg:block font-semibold text-xl break-words"> OPTICAL CLINIC MANAGEMENT SYSTEM
                  </p>
                </a>
                ...
                (<div className='w-2/6'>
                  <form>   
                    ...
                    <div className="relative">
                        <input type="search" id="default-search" className="placeholder:text-gray-400 font-medium block w-full pl-8 py-4 pr-4 text-sky-800 border border-sky-800 rounded-full bg-gray-50 sm:text-md focus:ring-blue-500 focus:border-blue-500" placeholder="Search resources..."/>
                        <button type="submit" className="text-white bg-white absolute right-2.5 bottom-2.5 rounded-full focus:ring-4 font-medium text-sm px-4 py-2">
                          <svg aria-hidden="true" className="w-6 h-6 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="4" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg>
                        </button>
                    </div>
                  </form>
                </div>):
