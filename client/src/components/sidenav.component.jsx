...
function Sidenav() {
  ...
  return (
    ...
    <aside
        id="logo-sidebar"
        className={classNames(isExpanded ? null: "-translate-x-1/2 ml-24",'sticky z-10 w-72 left-0 sidenav transition-transform bg-white border-r border-gray-200')}
        aria-label="Sidebar"
      >
      ...
      <div className="border-t">
        <div className="m-3 flex items-center self-end">
          <div className="px-3 mr-5">
            <img src="/images/dash-logo.png" alt="" className="object-contain" />
          </div>
