      ...
      <div className="mx-auto max-w-screen-2xl px-2 sm:px-6 lg:px-8">
        ...
        <div className='grid grid-cols-11 gap-4'>
          ...
          <div className='mb-10 col-start-4 col-span-8 row-start-1 row-span-1'>
            <p className='text-9xl font-medium text-center'>WELCOME</p>
          </div>
          ...
          <div className='flex col-start-6 col-span-4 px-8 justify-between'>

            <div>
              <input id="remember" type="radio" value="" name="default-radio" className="w-4 h-4 text-sky-500 bg-gray-100 border-gray-300 focus:ring-blue-500 focus:ring-2"/>
              <label htmlFor="remember" className="ml-2 text-xl font-semibold text-sky-800">Remember Me</label>
            </div>

            <div>
              <a className="ml-2 text-xl font-semibold text-sky-400 hover:underline cursor-pointer">
                Reset Password
              </a>
            </div>
          ...
          <div className='col-start-6 col-span-4 row-start-4 px-8'>
            <button type="submit" className="w-full font-semibold text-white bg-sky-800 hover:bg-sky-700 focus:ring-4 focus:outline-none focus:ring-sky-600 rounded-lg text-base px-6 py-3.5 text-center">
              Sign In
            </button>
            <div className='flex mt-3 justify-between'>
              <p className='text-base font-semibold text-sky-400 hover:underline cursor-pointer'>Don't have an account?</p>
              <Link to="/register" className='text-base font-semibold text-sky-800 hover:underline cursor-pointer'>Sign Up</Link>
            </div>
